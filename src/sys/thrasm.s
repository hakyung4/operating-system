...
_thread_startup:
        ...
        mv      t0, s8 # move entry function reference

        mv      a0, s0 # move all saved registers into argument register for the entry function
        mv      a1, s1
        mv      a2, s2
        mv      a3, s3
        mv      a4, s4
        ...
        jalr    ra, 0(t0) # go to entry
        call    thread_exit # upon return from entry, job finished we can go home now
